---
aliases: 
abilitymodifiers: +2 Con, +2 Int, –2 Wis
cssclasses: 
hitpoints: 2
size: Medium
sizeandtype: Elebrians are Medium humanoids with the elebrian subtype.
tags: 
type: humanoid (elebrian)
blurb: "[[Elebrian-Blurb.png]]"
---
...
## Adventurers
Most elebrians adventure for selfish reasons, while others are disillusioned with the cutthroat nature of life on Eox and just want to live where they can breathe freely. Elebrians prefer using their intellect to overcome obstacles and make exceptional [[Technomancer|technomancers]] and [[Mechanic|Mechanics]]. Some looking to cheat death even become [[Evolutionist]] or [[Nanocyte]].
