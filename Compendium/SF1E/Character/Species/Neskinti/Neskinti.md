...
blurb: "[[Neskinti-Blurb.png]]"
cssclasses: 
hitpoints: 4
portrait: 
size: Medium
sizeandtype: Neskintis are Medium humanoids with the neskinti subtype.
source: "Starfinder #8: Escape from the Prison Moon pg. 50"
stats: 
tags: 
...
**Source** _Starfinder #8: Escape from the Prison Moon pg. 50_
...
**Average Height** (height:: 6 ft.  )
**Average Weight** (weight:: 150 lbs.)  
**Age of Maturity** (maturity:: 20 years ) 
**Maximum Age** (age:: 120 years)