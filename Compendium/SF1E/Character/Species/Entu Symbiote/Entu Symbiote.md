---
aliases: 
abilitymodifiers: +2 Int
blurb: "[[Entu Symbiote.png]]"
cssclasses: 
date created: Tuesday, August 22nd 2023, 4:01:13 pm
date modified: Wednesday, August 21st 2024, 7:56:14 pm
hitpoints: 4
size: Small/ Medium/ Large
sizeandtype: Entu symbiotes are Small, Medium, or Large animals with the entu symbiote subtype.
tags: []
type: animal (entu symbiote)
---
...
The only augmentations that can be installed in an entu symbiote’s brain are [[Datajack]] and the mechanic’s custom rig. 
...
Entu symbiotes have the [[Natural Weapons Ex]] universal creature rule with a kinetic damage type chosen at character creation. 
...
**Average Height** (height:: Varies by animal)
**Average Weight** (weight:: Varies by animal)
