...
tags: 
cssclasses: 
abilitymodifiers: +2 Dex, +2 Con, -2 Cha
blurb: "[[Brakim-Blurb.png]]"
hitpoints: 4
size: Medium
sizeandtype: Brakims are Medium humanoids with the brakim subtype.
...
## Vital Stats
**Average Height** (height:: 7-1/2 ft.)
**Average Weight** (weight:: 200 lbs.)
**Age of Maturity** (maturity:: 15 years)
**Maximum Age** (age:: 75 years)
