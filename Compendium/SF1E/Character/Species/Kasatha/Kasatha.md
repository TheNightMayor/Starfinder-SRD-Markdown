---
abilitymodifiers: +2 Str, +2 Wis, -2 Int
aliases:
  - kasatha
  - kasathas
  - kasatha's
...
section: core
size: Medium
sizeandtype: Kasathas are Medium humanoids with the kasatha subtype.
tags: 
type: humanoid (kasatha)
stats: Kasatha-Card-Stats.jpg
portrait: Kasatha-Card-Portrait.jpg
---
...
Kasathas strive to maintain open trade with all races, yet they find some more amicable than others. They see [[Vesk]] as brutish and shameful in their focus on conquest by any means, and [[Ysoki]] as loud and undignified. They get along well with [[Lashunta|lashuntas]], who properly respect the knowledge of the past, and they are intrigued by both [[Android|androids]] and [[Shirren|shirrens]]—races they see as young enough to be led down proper paths. [[Human|humans]] often confuse them; just when they’re ready to write all humans off as capricious, they meet one whose sense of honor almost matches their own.

## Adventurers

Kasathas originally brought the philosophy of star cycles and cosmic balance to the Pact Worlds, and to this day most [[Solarian]]s are kasathas, though their physiques and love of dueling also make them excellent [[Soldier|soldiers]], and the study of ancient traditions turns many into [[Mystic]]s. Kasathas undergoing the Tempering make perfect explorers and adventurers, and in recent generations these walkabouts sometimes turn permanent.
...
**Average Weight** (weight:: 120-200 lbs.)
**Age of Maturity** (maturity:: 25 years)
**Maximum Age** (age:: 100+2d20 years)
