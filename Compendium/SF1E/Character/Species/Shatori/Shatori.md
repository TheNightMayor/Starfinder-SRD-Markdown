...
hitpoints: 4
size: Medium
sizeandtype: Shatoris are Medium humanoids with the shatori subtype.
tags: 
...
**Average Weight** (weight:: 125 to 250 lbs. )
**Age of Maturity** (maturity:: years)
**Maximum Age** (age:: — years)
