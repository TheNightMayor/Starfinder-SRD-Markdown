...
hitpoints: 6
size: Medium
sizeandtype: Shakaltas are Medium humanoids with the shakalta subtype.
tags: 
...
**Average Height** (height:: 5-1/2 to 7-1/2 ft. )
**Average Weight** (weight:: 75 to 125 lbs. )
**Age of Maturity** (maturity:: 3 years)
**Maximum Age** (age:: 500+5d% years)
