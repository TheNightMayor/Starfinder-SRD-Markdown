...
Ecology:
  ...
  - name: Organization
    desc: solitary, pair, or think tank (3–6)
Environment: any (moons of Hadrogess)
Gear:
  - name: Gear
    desc: "[[Stationwear#Stationwear, Casual|casual stationwear]], [[Arc Pistol#Arc Pistol, Static| static arc pistol]] with 1 [[Battery#Battery, Standard|Battery]] (20 charges), [[Baton#Baton, Tactical|tactical baton]]"
  - name: Augmentations
    desc: "[[Datajack#Datajack, Standard|standard datajack]]"
hp: 35
Init: 2
KAC: 15
...
Melee:
  - name: Melee
    desc: tactical baton +7 to hit (1d4+3 B)
modifier: 2
name: Hadrogaan, Hyper-analyst
image: "[[Hadrogaan Hyper-analyst.png]]"
offabilities:
  - name: Offensive Abilities
    desc: "[[Mechanic Tricks#Overload Weapon (EX)|overload]] (DC 14), [[Exocortex#Combat Tracking (EX) - 1ST Leveltarget tracking]]"
otherabil: "[[Mechanic#Artificial Intelligence (EX) - 1ST Levellartificial intelligence]] ([[Mechanic#Exocortexexocortex]]), [[Mechanic#Custom Rig (EX) - 1ST Level|custom rig]], [[Mechanic Tricks]] ([[Mechanic Tricks#Portable Power (EX)|portable power]]) "
Perception: 8
Ranged:
  - name: Ranged
...
```statblock
creature: Hadrogaan, Hyper-analyst
```
