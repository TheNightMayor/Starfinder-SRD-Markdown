...
Ecology:
  - name: Environment
    desc: any
  - name: Organization
    desc: solitary, small command (1–2 plus 4–10 hobgoblin troopers), command unit (3–6 plus 1 ja noi)
Environment: any
environment: any
Gear:
  - name: Gear
    desc: "[[Golemforged Plating#Golemforged Plating, Iii|golemforged plating III]], [[Laser Rifle#Laser Rifle, Corona|Corona Laser Rifle]] with 2 [[Battery#Battery, High-capacity|High-capacity Batteries]] (40 charges each), [[Longsword#Longsword, Sintered|sintered longsword]], [[Stickybomb Grenade#Stickybomb Grenade, Mk 2|stickybomb grenades II]] (2)"
hp: 105
Init: 5
...
Melee:
  - name: Melee
    desc: sintered longsword +14 to hit (2d8+13 S)
modifier: 5
name: Hobgoblin, Lieutenant
image: "[[Hobgoblin Lieutenant.png]]"
offabilities:
  - name: Offensive Abilities
    desc: "[[Fighting Styles]] ([[Hit-and-Run]]), furious combatant, [[Hit-and-Run#Nimble Fusillade (EX)|nimble fusillade]], [[Hit-and-Run#Opening Volley (EX)|opening volley]]"
Perception: 14
Ranged:
  - name: Ranged
...
specialabil:
  - name: Battle Hardened (Ex)
    desc: Hobgoblins are trained for combat from an early age, and they quickly learn that a foe can do much more than just hurt you. Hobgoblins gain a +1 racial bonus to AC against combat maneuvers.
  - name: Furious Combatant (Ex)
    desc: When a hobgoblin lieutenant scores a critical hit against a foe, the hobgoblin can attempt an Intimidate check to demoralize that foe as a reaction.
species: "[[Hobgoblin]]"
