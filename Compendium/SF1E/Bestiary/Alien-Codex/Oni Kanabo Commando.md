...
Ecology:
  - name: Environment
    desc: any
  - name: Organization
    desc: solitary, pair, strike vanguard (1 with 2–12 hobgoblin troopers), or elite squad (2–5)
Environment: any
Gear:
  - name: Gear
    desc: "[[Golemforged Plating#Golemforged Plating, Ii|golemforged plating II]], [[Autotarget Rifle]] with 50 [[Rounds#Rounds, Longarm and Sniper|longarm rounds]], [[Curved Blade#Curve Blade, Carbon Steel|carbon steel curveblade]], [[Flash Grenade#Flash Grenade, Mk 1|flash grenades I]] (2)"
hp: 40
Init: 2
KAC: 18
...
Melee:
  - name: Melee
    desc: carbon steel curveblade +12 to hit (1d10+7 S; critical bleed 1d6)
modifier: 2
name: Oni, Kanabo Commando
image: "[[oni, kanabo commando.png]]"
offabilities:
...
specialabil:
  - name: Armor Savant (Ex)
    desc: Kanabo have an innate mastery of the use of armor. When wearing armor, they gain a +1 racial bonus to AC. When wearing heavy armor, their armor check penalty is 1 less severe than normal.
species: "[[Kanabo]]"
