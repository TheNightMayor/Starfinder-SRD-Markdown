...
Ecology:
  - name: Environment
    desc: any (Varturan)
  - name: Organization
    desc: solitary, pair, or assembly (12+)
Environment: any (Varturan)
Gear:
  - name: Gear
    desc: "[[Stationwear#Stationwear, Elite|elite stationwear]], [[Laser Pistol#Laser Pistol, Corona|corona laser pistol]] with 2 [[Battery#Battery, Standard|Batteries]] (20 charges each), [[Sap#Sap, Medium|medium sap]]"
hp: 80
Init: 2
KAC: 19
...
Melee:
  - name: Melee
    desc: medium sap +12 to hit (1d6+7 B nonlethal)
modifier: 2
name: Brenneri, Ambassador
image: "[[Brenneri Ambassador.png]]"
otherabil: "[[Envoy Improvisations]] ([[Envoy Improvisations#Clever Improvisations (EX)|clever improvisations]], [[Envoy Improvisations#Inspiring Boost (EX)|inspiring boost]] [17 SP], [[Envoy Improvisations#Long-range Improvisation (EX)|long-range improvisation]])"
Perception: 13
Ranged:
  - name: Ranged
