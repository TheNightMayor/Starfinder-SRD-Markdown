...
Ecology:
  - name: Environment
    desc: warm forests (Mulkaxi)
  - name: Organization
    desc: solitary, pair, or prickle (3–4)
Environment: warm forests (Mulkaxi)
Gear:
  - name: Gear
    desc: "[[D-Suit#D-suit, Iii|D-suit III]], [[Laser Pistol#Laser Pistol, Aphelion|aphelion laser pistol]] with 2 [[Battery#Battery, High-capacity|High-capacity Batteries]] (40 charges each), [[Knife#Knife, Tactical|tactical knife]]"
hp: 135
Init: 6
KAC: 23
...
Melee:
  - name: Melee
    desc: tactical knife +18 to hit (2d4+9 S)
modifier: 6
name: Huitz’plina
image: "[[Images/Aliens/Enemies/magical beast/huitz'plina/huitz'plina.png]]"
offabilities:
  - name: Offensive Abilities
    desc: "[[Operative#Debilitating Trick (EX) - 4TH Level|debilitating trick]], spine assault (Reflex DC 18, 27 P), [[Operative#Trick Attack (EX) - 1ST Level|trick attack]] +5d8, [[Operative#Triple Attack (EX) - 8TH Level|triple attack]]"
otherabil: "[[Operative Exploits]] ([[Operative Exploits#Certainty (Ex)|certainty]], [[Operative Exploits#Ever Vigilant (EX)|ever vigilant]]), predreaming, [[Operative Specializations|Specialization]] ([[Explorer]])"
Perception: 17
Ranged:
  - name: Ranged
...
Huitz’plinas use a mix of vocal chords and the thumping of their prehensile tails in their musical language, which makes it difficult for tailless beings to replicate
the language is full of idioms based on huitz’plinas’ glimpses of the future. Huitz’plina don’t often use instruments in their music. Instead, large choirs sing haunting melodies that drift down from the treetops.
Over the decades, the most curious huitz’plinas have found ways to be useful to local Azlanti operations with the goal of leaving their home planet to enter the wider universe. Some hunger for exploration
others follow fleeting visions of themselves on strange new worlds. Several have returned after grand adventures, spurring more of their species to set out and explore, so huitz’plinas can now be found across the galaxy. Such huitz’plina travelers traditionally bring with them a petrified Mulkaxi flower blossom to remind them of where they come from. The blossoms vary in color, from rich blue to blood red to sea green, and they often become a huitz’plina’s most treasured object.
