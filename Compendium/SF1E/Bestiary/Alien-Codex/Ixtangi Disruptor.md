...
Ecology:
  - name: "Environment"
    desc: "any"
  - name: "Organization"
    desc: "solitary, pair, or glimmer (3–10)"
Environment: any
Gear:
  - name: "Gear"
    desc: "ixtangi survivalwear (functions as [[Estex Suit#Estex Suit, Iii|estex suit III]]), [[Laser Rifle#Laser Rifle, Corona|Corona Laser Rifle]] with 2 [[Battery#Battery, High-capacity|High-capacity Batteries]] (40 charges each), [[Fangblade]] with 2 [[Battery#Battery, Standard|Batteries]] (20 charges each)"
hp: 105
Init: 5
KAC: 21
...
Melee:
  - name: "Melee"
    desc: "fangblade +15 to hit (1d12+9 S; critical bleed 1d8) or tail +15 to hit (2d6+9 P; critical barb poison [DC 18])"
modifier: 5
name: "Ixtangi, Disruptor"
image: "[[Ixtangi Disruptor.png]]"

otherabil: "liquid crystal display (DC 15), unflappable climber"
Perception: 14
Ranged:
  - name: "Ranged"
...
specialabil:
  - name: "Barb Poison (Ex)"
    desc: "If an ixtangi scores a critical hit with their racial natural weapon, their target must succeed at a fortitude save (DC = 10 + the ixtangi’s Constitution modifier + half the ixtangi’s level ) or gain the flat-footed condition until the end of its next turn. This is a poison effect."
  - name: "Liquid Crystal Display (Ex)"
    desc: "An ixtangi has an innate ability to change their coloration as a standard action; this produces one of the following effects.<ul><li>Glimmer: The ixtangi flashes their coloration in a display that distracts onlookers. Enemies within 30 feet that can see the ixtangi must succeed at a DC Will save (DC = 10 + the ixtangi’s Charisma modifier + half the ixtangi’s level ) or be fascinated for 1d4 rounds. A creature can be affected by this ability only once per day. This is a mind-affecting effect.</li><li>Stealth: The ixtangi mimics their surroundings, becoming almost invisible. They gain a +2 racial bonus to Stealth checks to hide until the beginning of their next turn. </li></ul>"
  - name: "Unflappable Climber (Ex)"
    desc: "An ixtangi is an adept climber, using their sticky paw pads, tongue, and prehensile tail to stay stuck to surfaces. An ixtangi is not flat-footed while climbing and can take 10 on Athletics: checks to climb even when in combat or immediate danger."
