...
Ecology:
  - name: "Environment"
    desc: "any (Akiton)"
  - name: "Organization"
    desc: "solitary, pair, colony (1–3 plus 3–9 khefaks), or infestation (2–8 plus 10–40 khefaks)"
...
Melee:
  - name: "Melee"
    desc: "claw +11 to hit (1d6+4 S)"
modifier: 2
name: "Khefak, Thasteron"
image: "[[khefak thasteron.png]]"
...
specialabil:
  - name: "Aura of Radiation (Ex)"
    desc: "A thasteron khefak’s aura is an emanation of low radiation."
  - name: "Break Objects (Ex)"
    desc: "When attacking an object, a thasteron khefak treats that object’s hardness as if it were 15 lower."
  - name: "Consume Objects (Ex)"
    desc: "A thasteron khefak can eat objects with hardness 15 or lower. A thasteron khefak deals 2 damage to the object it’s consuming per minute. A thasteron khefak is sated and stops feeding on a given day after dealing 100 damage this way."
