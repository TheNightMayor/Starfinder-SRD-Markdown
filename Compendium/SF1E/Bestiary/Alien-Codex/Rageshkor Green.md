...
Feats: "[[Cleave Combat|Cleave]]"
hp: 90
Init: 1
KAC: 20
Melee:
  - name: "Melee"
    desc: "tail +15 to hit (1d8+11 P; critical knockdown)"
modifier: 1
name: "Rageshkor, Green"
image: "[[rageshkor, green.png]]"

Perception: 13
Ranged:
  - name: "Ranged"
    desc: "spike +13 to hit (1d8+11 P)"
reach: "10 ft."
saves:
  - Fort: 11
  - Ref: 8
...
specialabil:
  - name: "Align Frill (Ex)"
    desc: "As a move action, a green rageshkor can align portions of the flexible frill of its back armor to block attacks from one enemy the rageshkor is observing. Doing so increases the rageshkor’s AC by 2 against attacks from that enemy until the start of the rageshkor’s next turn."
  - name: "Spike (Ex)"
