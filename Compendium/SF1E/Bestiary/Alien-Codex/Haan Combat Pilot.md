...
Gear:
  - name: Gear
    desc: "[[D-Suit#D-suit, I|D-suit I]], [[Semi-Auto Pistol#Semi-auto Pistol, Advanced|advanced semi-auto pistol]] with 60 [[Rounds#Rounds, Small Arm|small arm rounds]], [[Knife#Knife, Tactical|tactical knife]]"
hp: 102
Init: 5
KAC: 21
...
Melee:
  - name: Melee
    desc: balloon +12 to hit (see below) or tactical knife +12 to hit (2d4+9 S)
modifier: 5
name: Haan, Combat Pilot
image: "[[Haan Combat Pilot.png]]"
offabilities:
  - name: Offensive Abilities
    desc: firespray, [[Operative#Debilitating Trick (EX) - 4TH Level|debilitating trick]], [[Operative#Trick Attack (EX) - 1ST Level|trick attack]] +4d8
otherabil: "[[Operative Specializations]] ([[Operative Specializations#Daredevil|daredevil]])"
Perception: 15
planet: Bretheda
Ranged:
  - name: Ranged
