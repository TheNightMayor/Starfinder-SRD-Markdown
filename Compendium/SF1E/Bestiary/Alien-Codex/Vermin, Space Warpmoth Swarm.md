...
Ecology:
  - name: "Environment"
    desc: "any vacuum"
  - name: "Organization"
    desc: "solitary, pair, or delusion (3–6)"
...
Melee:
  - name: "Melee"
    desc: "swarm attack (2d6 P)"
modifier: 5
name: "Vermin (Space), Warpmoth Swarm"
image: "[[space vermin, warpmoth swarm.jpg]]"

offabilities:
  - name: "Offensive Abilities"
    desc: "distraction (DC 14)"
...
space: "10 ft."
specialabil:
  - name: Disorienting  Aura(Ex)
    desc: "A warpmoth swarm creates an oscillating light (colloquially called its warp) that is disorienting. A creature that is within this aura, can see the light, and fails a DC 14 Will saving throw can move at only half speed, rounded down to the nearest 5-foot increment. This is a mind-affecting effect."
Speed: 30 ft., fly 30 ft. (Su, perfect)
statblock: true
subtype: (swarm)
tags: [fine, Neutral, swarm, vermin]
type: vermin
XP: 2400
---

```statblock
creature: Vermin (Space), Warpmoth Swarm
```
