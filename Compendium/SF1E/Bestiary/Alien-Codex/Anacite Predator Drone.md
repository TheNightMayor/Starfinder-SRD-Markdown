...
Ecology:
  - name: "Environment"
    desc: "any (Aballon)"
  - name: "Organization"
    desc: "solitary, pair, or squadron (3–6)"
...
offabilities:
  - name: "Offensive Abilities"
    desc: "target lock"
otherabil: "[[Tracking Ex]] (heat), [[Unliving Ex|unliving]]"
Perception: 19
planet: Aballon
Ranged:
  - name: "Ranged"
...
space: "10 ft."
specialabil:
  - name: "Automatic Laser (Ex)"
    desc: "An anacite predator drone’s automatic laser can fire in automatic mode each round at up to five targets. The weapon has a range increment of 60 feet."
  - name: "Electric Ray (Ex)"
    desc: "An anacite predator drone’s electric ray has a range increment of 60 feet."
  - name: "Shortwave (Ex)"
  ...
  - name: "Target Lock (Ex)"
    desc: "As a move action, an anacite predator drone can lock on to a target within 60 feet that it can see. The anacite can have only one locked target at a time. Against the anacite’s attacks, a locked target gains no benefit from concealment less than total concealment, and a locked target reduces its bonus to AC due to cover by 2."
Speed: 30 ft., fly 60 ft. (Ex, perfect) 
statblock: true
subtype: (technological)
tags: [construct, large, LawfulNeutral, technological]
type: construct
XP: 9,600 
---

```statblock
creature: Anacite, Predator Drone
```
