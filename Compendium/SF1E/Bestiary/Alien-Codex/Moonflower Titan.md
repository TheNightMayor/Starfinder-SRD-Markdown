...
Ecology:
  - name: "Environment"
    desc: "any land"
  - name: "Organization"
    desc: "solitary, pair, or grove (1 plus 2–8 moonflowers)"
...
Melee:
  - name: "Melee"
    desc: "bite +30 to hit (6d10+26 B plus swallow whole)"
  - name: "Multiattack"
    desc: "bite +24 to hit (6d10+26 P plus swallow whole), 2 tentacles +24 to hit (5d6+26 B)"
modifier: 0
name: "Moonflower, Titan"
image: "[[Moonflower titan.png]]"

offabilities:
  - name: "Offensive Abilities"
    desc: "moon pulse, [[Swallow Whole Ex]] (0 or 10d6 A & B [see text], eac 30, KAC: 28, 75 hp)" 
otherabil: "pod spawn"
Perception: 28
reach: "20 ft."
saves:
...
specialabil:
  ...
  - name: "Root Tremor (Ex)"
    desc: "As a full action, a moonflower titan can thrust its roots and tentacles into the ground, causing a violent tremor. Each creature within a 50-foot-radius spread originating in the moonflower’s space must attempt a DC 22 Reflex saving throw. Those that fail take 10d6 bludgeoning damage and fall prone. Creatures that succeed take half the damage and remain standing."
