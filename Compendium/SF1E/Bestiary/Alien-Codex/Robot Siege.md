...
defabilities:
  - name: "Defensive Abilities"
    desc: "hardened, [[Integrated Weapons (Ex)]]"
...
Ecology:
  - name: "Environment"
    desc: "any"
  - name: "Organization"
    desc: "solitary, pair, or battery (3–8)"
Environment: any
environment: any
Gear:
  - name: "Gear"
    desc: "[[X-Gen Gun#X-gen Gun, Elite|elite x-gen gun]] with 400 [[Rounds#Rounds, Heavy|heavy rounds]], [[Stellar Cannon#Stellar Cannon, Heavy|heavy stellar cannon]] with 800 [[Scattergun Shells]], [[IMDS Missile Launcher]] with 2  [[Missile#Missile, Advanced|advanced missiles]]"
hp: 330
Init: 7
KAC: 31
Languages: "Common"
modifier: 7
name: "Robot, Siege"
image: "[[robot, siege.png]]"

offabilities:
  - name: "Offensive Abilities"
    desc: "autoload"
otherabil: "advanced movement, nanite repair, [[Unliving Ex|unliving]]"
Perception: 26
Ranged:
  - name: "Ranged"
...
space: "15 ft."
specialabil:
  - name: "Advanced Movement (Ex)"
    desc: "Difficult terrain doesn’t hamper a siege robot’s movement."
  - name: "Autoload (Ex)"
    desc: "A siege robot can reload its weapons as part of the same action used to fire them."
  - name: "Hardened (Ex)"
    desc: "A siege robot takes half damage from explosives and collisions."
  - name: "Limited Flight (Ex)"
    desc: "A siege robot’s thruster-based flight works in a vacuum, but in gravity, it can fly a maximum of 10 feet above the ground."
  - name: "Nanite Repair (Ex)"
    desc: "A siege robot’s nanites heal it, restoring a number of Hit Points per hour equal to its CR. Once per day as a full action, the robot can regain 10d8 Hit Points."
Speed: 60 ft., fly 20 ft. (Ex, clumsy); limited flight"
statblock: true
subtype: (technological)
tags: [construct, huge, Neutral, technological]
type: construct
XP: 51200 
---

```statblock
creature: Robot, Siege
```
