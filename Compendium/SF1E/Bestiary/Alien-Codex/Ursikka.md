...
Melee:
  - name: "Melee"
    desc: "bite +23 to hit (2d10+18 P plus freezing saliva) or claw +23 to hit (2d10+18 S)"
modifier: 3
name: "Ursikka"
image: "[[Ursikka.png]]"
...
offabilities:
  - name: "Offensive Abilities"
    desc: "coat claws, freezing saliva, spit"
otherabil: "hibernation"
Perception: 19
reach: "15 ft."
saves:
  - Fort: 14
...
specialabil:
  - name: "Coat Claws (Ex)"
    desc: "As a standard action, an ursikka can coat its pincerlike claws with freezing, viscous saliva. This coating lasts for 1 minute. Any creature hit by an ursikka’s coated claws takes an additional 2d10 cold damage (Reflex DC 17 half)."
  - name: "Freezing Saliva (Ex)"
    desc: "The saliva that drips from an ursikka’s mouth is sticky as well as cold, and any creature hit by its bite or spit attack becomes entangled for 1d4 rounds (Reflex DC 17 negates). At the end of each turn they’re entangled, a creature takes 2d10 cold damage. An entangled creature can end the entangled condition early with a successful DC 17 Acrobatics: or Strength check as a standard action, or by dealing 15 points of fire or slashing damage to the saliva."
  - name: "Hibernation (Ex)"
    desc: "An ursikka can enter a prolonged state of hibernation by weaving a cocoon from its spittle. It takes 1 uninterrupted hour of work for an ursikka to create this cocoon and an additional 24 hours for the cocoon to fully harden, after which it has hardness 10 and 100 Hit Points. While hibernating, an ursikka doesn’t need to drink or eat. As long as the cocoon remains intact, the ursikka remains unharmed in its hibernation. An ursikka must use its attacks to break free from its cocoon."
  - name: "Ice Burrow (Ex)"
    desc: "Ursikkas have evolved to thrive in icy climes that are inhospitable to most other creatures. In addition to dirt, ursikkas can burrow through solid ice and through packed snow of any density."
  - name: "Spit (Ex)"
    desc: "As a standard action, an ursikka can spit a 60-foot line of its saliva. Creatures in the area take 6d10 cold damage and become entangled. A successful DC 17 Reflex save halves the damage and negates the entangled condition."
