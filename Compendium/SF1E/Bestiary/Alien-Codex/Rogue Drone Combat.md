...
Environment: any
Feats: "[[Cleave Combat]], [[Great Cleave Combat]], [[Lunge Combat]], [[Mobility Combat|Mobility]], [[Sidestep Combat]], [[Spring Attack Combat|Spring Attack]]"
Gear:
  - name: "Gear"
    desc: "[[Obscuring]] [[Hailcannon#Hailcannon, Absolute-zero|absolute-zero hailcannon]] with 1 [[Battery#Battery, Super-capacity|Super-capacity Battery]], [[Dagger#Dagger, Zero-edge|zero-edge dagger]],  [[Nanite Patch#Nanite Patch, Mk 3|mk 3 nanite patch]]"
hp: 250
Init: 6
KAC: 32
Languages: "Common"
Melee:
  - name: "Melee"
    desc: "zero-edge dagger +27 to hit (6d4+22 S)"
modifier: 6
name: "Rogue Drone, Combat"
image: "[[rogue combat drone.png]]"

otherabil: "[[Drone Mods]] ([[Drone Mods#Echolocators (EX)|echolocators]], [[Drone Mods#Enhanced Armor (EX)|enhanced armor]], [[Drone Mods#ex|excavator]], [[Drone Mods#Melee Weapon Arm (EX)|melee weapon arm]], [[Drone Mods#Reductive Plating (EX)|reductive plating]], [[Drone Mods#Skill Subroutines (EX)|skill subroutine]] [Athletics], [[Drone Mods#Weapon Proficiency (EX)|weapon proficiencies]] [2+2], [[drone mods#Weapon Mount (EX)|weapon mounts]] [2]), [[Unliving Ex|unliving]]"
Perception: 30
Ranged:
  - name: "Ranged"
...
tags: [ChaoticNeutral, construct, Medium, technological]
