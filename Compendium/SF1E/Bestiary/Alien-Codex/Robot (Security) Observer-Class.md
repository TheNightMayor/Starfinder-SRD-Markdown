...
defabilities:
  - name: "Defensive Abilities"
    desc: "exigency, [[Integrated Weapons (Ex)]]"
...
Ecology:
  - name: "Environment"
    desc: "any urban"
  - name: "Organization"
    desc: "solitary or fleet (2–5)"
Environment: any urban
Gear:
  - name: "Gear"
    desc: "[[Defrex Hide]] with 2 [[Battery#Battery, Standard|Batteries]] (20 charges each), [[Stickybomb Grenade#Stickybomb Grenade, Mk 1|stickybomb grenades I]] (2)"
hp: 17
Init: 4
KAC: 15
Languages: "Common"
Melee:
  - name: "Melee"
    desc: "slam +6 to hit (1d6+3 B)"
modifier: 4
name: "Robot (Security), Observer-Class"
image: "[[robot, observer-class security.png]]"
...
specialabil:
  - name: "Exigency (Ex)"
    desc: "An observer-class security robot can expend a large store of energy to temporarily increase its processing power and attempt to avoid an attack. Once per day, it can reroll a failed Reflex saving throw with a +10 circumstance bonus."
...
```statblock
creature: Robot (Security), Observer-Class
```
