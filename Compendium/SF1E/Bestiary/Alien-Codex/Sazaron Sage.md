...
Ecology:
  - name: Environment
    desc: any (Arkanen)
  - name: Organization
    desc: solitary, pair, or assembly (3–15)
Environment: any (Arkanen)
Gear:
  - name: Gear
    desc: "[[AbadarCorp Travel Suit#Abadarcorp Travel Suit, Platinum|platinum AbadarCorp travel suit]], [[Laser Pistol#Laser Pistol, Perihelion|perihelion laser pistol]] with 2 [[Battery#Battery, High-capacity|High-capacity Batteries]] (40 charges each), [[Dueling Sword#Dueling Sword, Ultrathin|ultrathin dueling sword]]"
hp: 170
Init: 5
KAC: 26
Languages: Arkanen, Brethedan, Common, Dirindi, Sazaron; [[Limited Telepathy (Ex or Su)]] 30 ft.
Melee:
  - name: Melee
    desc: tail slap +20 to hit (2d12+15 B) or ultrathin dueling sword +20 to hit (3d6+15 S)
modifier: 5
name: Sazaron, Sage
...
Ranged:
  - name: Ranged
    desc: perihelion laser pistol +22 to hit (4d4+12 F; critical burn 2d4)
