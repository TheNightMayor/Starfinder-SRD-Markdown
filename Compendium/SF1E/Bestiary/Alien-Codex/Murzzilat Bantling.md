...
Ecology:
  ...
  - name: "Organization"
    desc: "solitary, litter (2–6), or choir (2–6 plus 1 murzzilat)"
...
Melee:
  - name: "Melee"
    desc: "bite +8 to hit (1d6+5 P) or Attach +8"
modifier: 2
name: "Murzzilat, Bantling"
image: "[[Murzzilat Bantling.png]]"

otherabil: "[[Amphibious (Ex)]], [[Compression (Ex)]], [[Water Breathing Ex]]"
Perception: 5
Ranged:
  - name: "Ranged"
...
specialabil:
  - name: "Melodic Assault (Ex)"
    desc: "As a ranged attack that targets eac, a murzzilat bantling can sing a sonic blast with a range increment of 30 feet at a single target."
Speed: 10 ft., fly 20 ft. (Ex, perfect), swim 20 ft.
statblock: true
subtype: (aquatic)
tags: [animal, aquatic, Neutral, Small]
...
```statblock
creature: Murzzilat, Bantling
```

## Bantling Cr 1

Deep in the lightless depths of countless worlds live murzzilats, [[Amphibious (Ex)]] mammals known for their grotesque contortions and ethereal vocalizations. Capable of both swimming and flight, these creatures are ungainly on land but well adapted to life in partially submerged tunnels and caverns, where their songs echo for miles in a haunting underground symphony.
