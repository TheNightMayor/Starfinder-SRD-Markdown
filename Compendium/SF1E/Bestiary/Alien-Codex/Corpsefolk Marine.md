...
Ecology:
  - name: Environment
    desc: any (Eox)
  - name: Organization
    desc: solitary, pair, or elite squad (3–5)
Environment: any (Eox)
environment: any
Gear:
  - name: Gear
    desc: "[[Defiance Series#Defiance Series, Elite|elite defiance series]], [[Acid Dart Rifle#Acid Dart Rifle, Dual|dual acid dart rifle]] with 48 [[Darts]], [[Pulse Gauntlet#Pulse Gauntlet, Lfd|LFD pulse gauntlet]] with 2 [[Battery#Battery, Standard|Batteries]] (20 charges each), [[Frag Grenade#Frag Grenade, Mk 1|frag grenades I]]I (2)"
hp: 126
Init: 9
KAC: 22
Languages: Common
Melee:
  - name: Melee
    desc: LFD pulse gauntlet +14 to hit (2d6+9 B & So; critical knockdown)
modifier: 9
name: Corpsefolk, Marine
image: "[[Corpsefolk Marine.png]]"
offabilities:
  - name: Offensive Abilities
    desc: "[[Fighting Styles]] ([[Sharpshoot]]), [[Sharpshoot#Focus Fire (EX)|focus fire]], [[Sharpshoot#SNIPER’S Aim (EX)|sniper’s aim]]"
