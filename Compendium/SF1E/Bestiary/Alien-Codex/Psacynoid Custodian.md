...
Ecology:
  - name: Environment
    desc: any (Nolasa)
  - name: Organization
    desc: solitary, pair, band (3–5), or community (6–30 plus 1–3 psacynoid gallants)
Environment: any (Nolasa)
Gear:
  - name: Gear
    desc: "[[Stationwear#Stationwear, Casual|casual stationwear]], [[Staff#Staff, Battle|battle staff]], [[Semi-Auto Pistol#Semi-auto Pistol, Tactical|tactical semi-auto pistol]] with 18 [[Rounds#Rounds, Small Arm|small arm rounds]]"
hp: 31
Init: 2
KAC: 14
...
Melee:
  - name: Melee
    desc: battle staff +6 to hit (1d4+3 B; critical knockdown)
modifier: 2
name: Psacynoid, Custodian
image: "[[Psacynoid Custodian.png]]"
otherabil: "[[Multiarmed Ex]] (4), [[Melophile#Song of the Spheres (SU) - 1ST Level|song of the spheres]], [[Melophile#Universal Choir (SU) - 3RD Level|universal choir]]"
Perception: 8
Ranged:
  - name: Ranged
