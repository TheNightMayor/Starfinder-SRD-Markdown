...
Ecology:
  ...
  - name: Organization
    desc: solitary, pair, or convoy (1 overseer plus 3–6 miners)
Environment: any underground
environment: underground
Gear:
  - name: Gear
    desc: "[[Kasatha Microcord#Kasatha Microcord, Iii|kasatha microcord III]], [[Semi-Auto Pistol#Semi-auto Pistol, Advanced|advanced semi-auto pistol]] with 24 [[Rounds#Rounds, Small Arm|small arm rounds]], [[Staff#Staff, Carbon|carbon staff]]"
hp: 115
Init: 2
KAC: 22
...
Melee:
  - name: Melee
    desc: carbon staff +17 to hit (1d8+10 B; critical knockdown)
modifier: 2
name: Bolida, Overseer
image: "[[Bolida Overseer.png]]"
offabilities:
  - name: Offensive Abilities
    desc: "[[Mechanic Tricks#Overload Weapon (EX)|overload]] (DC 18), rolling charge, [[Exocortex#Combat Tracking (EX) - 1ST Level|target tracking]]"
otherabil: "[[Mechanic#Artificial Intelligence (EX) - 1ST Level|artificial intelligence]] ([[Mechanic#Exocortex|exocortex]]), [[Mechanic#Expert Rig (EX) - 7TH Level|expert rig]] (armor upgrade), [[Mechanic Tricks#Quick Repair (EX)| mechanic tricks (quick repair)]], [[Mechanic#Miracle Worker (EX) - 7TH Level|miracle worker]] (1/day), [[Mechanic#Remote Hack (EX) - 5TH Level|remote hack]] (DC 18), [[Exocortex#Wireless Hack (EX) - 5TH Level|wireless hack]]"
Perception: 18
planet: []
Ranged:
  - name: Ranged
