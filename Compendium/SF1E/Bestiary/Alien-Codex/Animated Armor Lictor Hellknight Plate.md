...
Gear:
  - name: "Gear"
    desc: "[[Laser Pistol#Laser Pistol, Corona|corona laser pistol]] with 4 [[Battery#Battery, Standard|Batteries]] (20 charges each), [[jetpack]], [[Thermal Capacitor#Thermal Capacitor, Mk 1|mk 1 thermal capacitor]]"
hp: 70
Init: 3
KAC: 19
Melee:
...
```statblock
creature: Animated Armor, Lictor Hellknight Plate
```
