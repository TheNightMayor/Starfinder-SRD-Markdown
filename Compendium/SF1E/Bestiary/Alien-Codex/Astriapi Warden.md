...
Gear:
  - name: Gear
    desc: "[[Stationwear#Stationwear, Elite|elite stationwear]], [[Spined Blade#Spined Blade, Basic|basic spined blade]], [[Laser Pistol#Laser Pistol, Corona|corona laser pistol]] with 1 [[Battery#Battery, Standard|Battery]] (20 charges), astriapi honey (functions as [[Serum of Healing#Serum of Healing, Mk 2|mk II serum of healing]])"
hp: 75
Init: 2
KAC: 18
...
Melee:
  - name: Melee
    desc: basic spined blade +10 to hit (1d6+6 P; critical injection DC +2) or bite +10 to hit (1d6+6 P)
modifier: 2
name: Astriapi, Warden
image: "[[Astriapi Warden.png]]"
offabilities:
...
specialabil:
  - name: Honey Production (Ex)
    desc: Once per day, an astriapi can spend 10 minutes to produce a vial of magical honey. This honey functions as a mk 1 serum of healing. At 5th level (or CR 5), the honey functions as a [[Serum of Healing#Serum of Healing, Mk 2|mk II serum of healing]], and at 9th level (or CR 9), it functions as a mk 3 serum of healing. Regardless of its level, the honey can’t be sold, and its magical properties expire after 24 hours, when it turns into mundane foodstuff.
species: "[[class:]]"
