...
Ecology:
  - name: Environment
    desc: cold deserts or mountains (Akiton)
  - name: Organization
    desc: solitary, clan (1 plus 20+ shobhads), or moot (2–8)
Environment: cold deserts or mountains (Akiton)
Gear:
  - name: Gear
    desc: advanced war harness (functions as [[D-Suit#D-suit, Ii|d-suit II]]), [[Longsword#Longsword, Sintered|sintered longswords]] (2), shobhad longrifle (functions as an [[Shirren-Eye Rifle#Shirren-eye Rifle, Advanced|advanced shirren-eye rifle]]) with 50 [[Rounds#Rounds, Longarm and Sniper|sniper rounds]]
hp: 105
Init: 6
KAC: 21
...
Melee:
  - name: Melee
    desc: sintered longsword +17 to hit (2d8+12 S)
  - name: Multiattack
    desc: 2 sintered longswords +12 to hit (2d8+12 S), 2 slams +12 to hit (1d6+12 B)`
modifier: 6
name: Shobhad, Warleader
image: "[[Shobhad Warleader.png]]"
offabilities:
  - name: Offensive Abilities
    desc: "[[Blitz#Charge Attack (EX)|charge attack]], [[Fighting Styles]] ([[Blitz]])"
Perception: 14
Ranged:
  - name: Ranged
