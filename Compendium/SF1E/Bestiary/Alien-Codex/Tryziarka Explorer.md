...
Ecology:
  - name: Environment
    desc: any
  - name: Organization
    desc: solitary, pair, or quest (3–8)
Environment: any
Gear:
  - name: Gear
    desc: "[[Carbon Skin#Carbon Skin, Graphite|graphite carbon skin]], [[Semi-Auto Pistol#Semi-auto Pistol, Tactical|tactical semi-auto pistol]] with 18 [[Rounds#Rounds, Small Arm|small arm rounds]], [[Knife#Knife, Survival|survival knife]]"
hp: 35
Init: 4
KAC: 15
Languages: Common
Melee:
  - name: Melee
    desc: survival knife +7 to hit (1d4+3 S)
modifier: 4
name: Tryziarka, Explorer
image: "[[Tryziarka Explorer.png]]"
offabilities:
  - name: Offensive Abilities
    desc: "[[Operative Alternate Class Features#Stunt & Strike (EX)|stunt and strike]], [[Operative Alternate Class Features#Culture Stunts|Culture stunts(analyze, distracting blather)]] Tryziarka Spell-Like Abilities (CL 3rd) 1/day—[[Stabilize]]"
otherabil: "[[Operative Exploits]] ([[Operative Exploits#Without a Trace (EX)|without a trace]]), [[Operative Specializations|Specialization]] ([[Explorer]]), tattoo magic, tattoo transference"
Perception: 9
Ranged:
  - name: Ranged
