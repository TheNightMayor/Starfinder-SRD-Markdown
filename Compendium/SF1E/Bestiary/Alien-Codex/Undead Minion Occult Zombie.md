...
Ecology:
  - name: "Environment"
    desc: "any"
  - name: "Organization"
    desc: "solitary, pair, pack (3–12), or horde (13+)"
Environment: any
environment: any
hp: 24
Init: 2
...
image: "[[undead minion, occult zombie.jpg]]"
...
specialabil:
  - name: "Staggered (Ex)"
    desc: "An occult zombie is always considered staggered and can never take more than a single move or standard action in a round. It can’t take full actions."
Speed: 30 ft. 
statblock: true
...
```statblock
creature: Undead Minion, Occult Zombie
```
