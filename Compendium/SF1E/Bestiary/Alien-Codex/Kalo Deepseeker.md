...
Ecology:
  ...
  - name: Organization
    desc: solitary or delegation (1 deepspeaker and honor guard of 3–6 kalo sharkhunters)
Environment: any aquatic (Kalo-Mahoi)
environment: aquatic
Gear:
  - name: Gear
    desc: "[[Lashunta Tempweave#Lashunta Tempweave, Basic|basic lashunta tempweave]], underwater [[Spear#Spear, Tactical|tactical spear]], underwater [[Zero Pistol#Zero Pistol, Frostbite-class|frostbite-class zero pistol]] with 3 [[Battery#Battery, Standard|Batteries]] (20 charges each)"
hp: 57
Init: 3
KAC: 17
Languages: Common, Kalo; [[Xenodruid#Speak with Animals (SU) - 1ST Level|speak with animals]]
Melee:
  - name: Melee
    desc: underwater tactical spear +8 to hit (1d6+5 P)
modifier: 3
name: Kalo Deepseeker
image: "[[kalo deepspeaker.png]]"
offabilities:
...
Although slower out of water, kalo warriors are renowned for their calm precision in battle, especially in zero-g and underwater, and known for using cryo weapons against enemies of other races, trusting their natural [[Energy Resistance]] to protect them from friendly fire. The average kalo is 5-1/2 feet tall and weighs 100 pounds.
