...
Melee:
  - name: "Melee"
    desc: "bite +28 to hit (8d6+20 P plus analyzed strike)"
modifier: 8
name: "Garaggakal, Polymath"
image: "[[Garaggakal polymath.png]]"

offabilities:
  - name: "Offensive Abilities"
    desc: "leech life (DC 20)"
...
space: "10 ft."
specialabil:
  - name: "Analyzed Strike (Ex)"
    desc: "A garaggakal polymath has spent centuries analyzing the species it has encountered in the Drift, and it uses this knowledge to target its prey’s most sensitive and vulnerable areas. Any creature that takes damage from the garaggakal’s bite attack must succeed at a DC 20 fortitude save or become off-kilter (in zero gravity) or off-target for 1 round (in gravity)."
  - name: "Leech Life (Su)"
    desc: "As a standard action, a garaggakal polymath can spend 1 Resolve Point to leech the life from one target within 30 feet. This deals 14d6 damage (fortitude DC 20 half), and the garaggakal gains temporary Hit Points equal to the amount of damage dealt."
