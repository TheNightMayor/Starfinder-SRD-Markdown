...
Ecology:
  - name: Environment
    desc: any urban (Colveare)
  - name: Organization
    desc: solitary, pair, or patrol (3–8)
Environment: any urban (Colveare)
Gear:
  - name: Gear
    desc: "[[Ceremonial Plate#Ceremonial Plate, Troop|troop ceremonial plate]], [[Taclash#Taclash, Standard|standard taclash]], [[Arc Caster#Arc Caster, Static|static arc caster]] with 2 [[Battery#Battery, Standard|Batteries]] (20 charges each), [[Stickybomb Grenade#Stickybomb Grenade, Mk 1|stickybomb grenades I]] (2), astriapi honey (functions as [[Serum of Healing#Serum of Healing, Mk 1|mk 1 serum of healing]])"
hp: 20
Init: 8
KAC: 13
...
Melee:
  - name: Melee
    desc: standard taclash +5 to hit (1d4+3 S nonlethal) or bite +5 to hit (1d6+3 P)
modifier: 8
name: Astriapi, Defender
image: "[[Astriapi Defender.png]]"
offabilities:
  - name: Offensive Abilities
    desc: "[[Fighting Styles]] ([[Guard]])"
otherabil: honey production
Perception: 5
Ranged:
  - name: Ranged
...
specialabil:
  - name: Honey Production (Ex)
    desc: Once per day, an astriapi can spend 10 minutes to produce a vial of magical honey. This honey functions as a mk 1 serum of healing. At 5th level (or CR 5), the honey functions as a [[Serum of Healing#Serum of Healing, Mk 2|mk II serum of healing]], and at 9th level (or CR 9), it functions as a mk 3 serum of healingjust . Regardless of its level, the honey can’t be sold, and its magical properties expire after 24 hours, when it turns into mundane foodstuff.
species: Astriapi
