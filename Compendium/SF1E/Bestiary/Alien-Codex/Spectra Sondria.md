...
defabilities:
  ...
  - name: DR
    desc:  10/chaotic, evil, good, or law
...
Ecology:
  - name: "Environment"
    desc: "any (the Drift)"
  - name: "Organization"
    desc: "solitary, sequence (2, 3, 5, or 8), or triarmament (1 aspecna plus 2 sondrias)"
...
Melee:
  - name: "Melee"
    desc: "claw +28 to hit (8d6+22 S; critical Drift dash)"
  - name: "Multiattack"
    desc: "4 claws +22 to hit (4d6+22 S; critical Drift dash)"
modifier: 6
...
specialabil:
  - name: "Drift Boost (Ex)"
    desc: "A sondria can attach themself to a starship of any size and lend that ship the use of their slip drive, allowing the ship to travel through the Drift. The ship uses the Drift engine rating for the sondria’s slip drive (7 for a CR 14 sondria) and needs to remain stationary for only 6 seconds before engaging the drive."
  - name: "Drift Dash (Ex)"
