...
Melee:
  - name: "Melee"
    desc: "bite +16 to hit (1d8+9 P) or claws +16 to hit (1d8+9 S)"
modifier: 5
name: "Hound of Tindalos"
image: "[[Hound of Tindalos.png]]"
...
specialabil:
  ...
  - name: "Otherworldly Mind (Ex)"
    desc: "Any creature that uses a mind-affecting effect on a hound or communicates with it telepathically must attempt a DC 17 Will saving throw. A creature that fails takes 4d10 damage and becomes confused for 2d4 rounds. This is a mind-affecting effect."
...
tags: [evil, extraplanar, Medium, NeutralEvil, outsider]
