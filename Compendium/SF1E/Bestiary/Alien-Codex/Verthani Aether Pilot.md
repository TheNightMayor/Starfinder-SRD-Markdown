...
Gear:
  - name: Gear
    desc: "[[Estex Suit#Estex Suit, I|estex suit I]], [[Arc Pistol#Arc Pistol, Static| static arc pistol]] with 2 [[Battery#Battery, Standard|Batteries]] (20 charges each), [[Knife#Knife, Survival|survival knife]], [[Shirren-Eye Rifle#Shirren-eye Rifle, Tactical|tactical shirren-eye rifle]] with 20 [[Rounds#Rounds, Longarm and Sniper|longarm rounds]]"
  - name: Augmentations
    desc: "[[Datajack]], prosthetic arm"
hp: 23
Init: 4
KAC: 15
...
Melee:
  - name: Melee
    desc: survival knife +6 to hit (1d4+3 S)
modifier: 4
name: Verthani, Aether Pilot
image: "[[Verthani Aether Pilot.png]]"
offabilities:
  - name: Offensive Abilities
    desc: "[[Operative#Trick Attack (EX) - 1ST Level|trick attack]] +1d4"
otherabil: "[[Operative Exploits]] ([[Operative Exploits#Uncanny Pilot (EX)|uncanny pilot]]), [[Operative Specializations]] ([[Operative Specializations#Ghost|ghost]]), skin mimic"
Perception: 8
planet: Verces
Ranged:
  - name: Ranged
...
```statblock
creature: Verthani, Aether Pilot
```
