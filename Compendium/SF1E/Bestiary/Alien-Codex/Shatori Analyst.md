...
Ecology:
  - name: Environment
    desc: any (Perdure)
  - name: Organization
    desc: solitary, team (2–5), or convention (6–11)
Environment: any (Perdure)
Gear:
  - name: Gear
    desc: "[[Carbon Skin#Carbon Skin, Graphite|graphite carbon skin]], [[Dueling Sword#Dueling Sword, Tactical|tactical dueling sword]], [[Semi-Auto Pistol#Semi-auto Pistol, Tactical|tactical semi-auto pistol]] with 27 [[Rounds#Rounds, Small Arm|small arm rounds]], [[Datapad]]"
hp: 43
Init: 3
KAC: 16
...
Melee:
  - name: Melee
    desc: tactical dueling sword +6 to hit (1d6+2 S)
modifier: 3
name: Shatori, Analyst
image: "[[Shatori Analyst.png]]"
otherabil: "[[technomancer#Magic Hack - 2ND Level|magic hacks]] ([[Magic Hacks#Quick Scan (SU)|quick scan]]), psychometry, shared stillness, [[Technomancer#Spell Cache (SU) - 1ST Level|spell cache]] ([[Datapad]])"
Perception: 10
Ranged:
  - name: Ranged
