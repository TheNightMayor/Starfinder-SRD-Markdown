...
Melee:
  - name: "Melee"
    desc: "claw +12 to hit (1d6+5 S)"
modifier: 3
name: "Vasporan, Broodling"
image: "[[Vasporan Broodling.png]]"

offabilities:
  - name: "Offensive Abilities"
    desc: "ambush strike"
otherabil: "autotomous flight"
Perception: 10
Ranged:
  - name: "Ranged"
...
specialabil:
  - name: "Ambush Strike (Ex)"
    desc: "A vasporan deals 1d6 additional damage against any creature unaware of it."
  ...
  - name: "Flash Molt (Ex)"
    desc: "As a reaction when hit by an attack that targets its kac, a vasporan can molt its flesh to attempt to avoid the attack. The vasporan gains hardness 10 against the attack’s damage and can take a guarded step. The vasporan can’t use flash molt again for 1d4 rounds."
  - name: "Spines (Ex)"
