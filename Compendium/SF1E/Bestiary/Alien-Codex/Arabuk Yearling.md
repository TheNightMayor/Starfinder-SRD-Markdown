...
defabilities:
  - name: "[[Energy Resistance]]"
    desc: cold 10, sonic 5
EAC: 14
Ecology:
  - name: Environment
    desc: arctic (Akiton)
  - name: Organization
    desc: solitary, pair, or glaring (2–4 plus 1 arabuk)
...
Melee:
  - name: Melee
    desc: bite +11 to hit (1d6+7 P) or antlers +11 to hit (9 (1d4+7)) B plus 3 (1d6) So)
modifier: 2
name: Arabuk, Yearling
image: "[[arabuk yearling.png]]"
offabilities:
