...
Gear:
  - name: Gear
    desc: "[[Vesk Overplate#Vesk Overplate, I|vesk overplate I]] with [[Filtered Rebreather]], [[Frag Grenade#Frag Grenade, Mk 1|frag grenades I]]I (2), [[Plasma Pistol#Plasma Pistol, Red Star|red star plasma pistol]] with 4 [[Battery#Battery, Standard|Batteries]] (20 charges each)"
  - name: Augmentations
    desc: Damoritosh’s arm [[Symbiend]]
hp: 90
Init: 6
KAC: 23
Languages: Common
Melee:
  - name: Melee
    desc: unarmed strike +16 to hit (1d3+14 B)
modifier: 6
name: Symbiend, Damoritosh's Arm Host
image: "[[symbiend, damoritosh's arm host.png]]"
offabilities:
  - name: Special Attacks
    desc: "[[Blitz#Charge Attack (EX)|charge attack]], [[Fighting Styles]] ([[Blitz]]), frothing rage"
Perception: 13
Ranged:
  - name: Ranged
...
```statblock
creature: Symbiend, Damoritosh's Arm Host
```
