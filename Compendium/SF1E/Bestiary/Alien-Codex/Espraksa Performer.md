...
Gear:
  - name: Gear
    desc: "[[Lashunta Tempweave#Lashunta Tempweave, Basic|basic lashunta tempweave]],  [[Perforator Pistol#Perforator Pistol, Diffraction|diffraction perforator pistol]] with 2 [[Battery#Battery, Standard|Batteries]] (20 charges each),  [[Battle Ribbon#Battle Ribbon, Traditional|traditional battle ribbon]]"
Init: 3
KAC: 17
Languages: Akitonian, Brethedan, Castrovelian, Common, Espraksi, Shirren, Triaxian, Vercite
Melee:
  - name: Melee
    desc: traditional battle ribbon +10 to hit (1d8+1 S) or talon +10 to hit (1d4+5 P plus snatch)
modifier: 3
name: Espraksa, Performer
image: "[[Espraksa Performer.png]]"
otherabil: cold inured, [[Envoy Improvisations]] ([[Envoy Improvisations#Clever Attack (EX)|clever attack]], [[Envoy Improvisations#Clever Feint (EX)|clever feint]])
Perception: 10
Ranged:
  - name: Ranged
...
specialabil:
  - name: Cold Inured (Ex)
    desc: An espraksa treats severe cold as cold and extreme cold as severe cold.
  - name: Snatch (Ex)
    desc: "This functions as the grab universal creature rule, except the espraksa must hit with two talon attacks during the same turn to grab. Only one talon must hit the target’s KAC: + 4 (or + 13) to trigger the free grab (or pin), but both must hit."
species: "[[Starfinder-SRD/Compendium/Bestiary/Alien-Codex/need links/Espraksa]]"
