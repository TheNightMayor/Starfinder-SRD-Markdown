...
defabilities:
  - name: Defensive Abilities
    desc: "[[Unflankable (Ex)]], unshakable belief"
EAC: 16
Ecology:
  - name: Environment
    desc: any
...
Gear:
  - name: Gear
    desc: "[[Estex Suit#Estex Suit, Ii|estex suit II]], [[Zero Pistol#Zero Pistol, Frostbite-class|frostbite‑class zero pistol]] with 2 [[Battery#Battery, Standard|Batteries]] (20 charges each)"
hp: 60
Init: 3
KAC: 17
Languages: Jinsul
Melee:
  - name: Melee
    desc: bite +9 to hit (1d4+5 P) or leg blade +9 to hit (1d6+5 S; critical bleed 1d8)
modifier: 3
name: Jinsul, Base Commander
image: "[[Jinsul Base Commander.png]]"
otherabil: "[[technomancer#Magic Hack - 2ND Level|magic hacks]] ([[Magic Hacks#Empowered Weapon (SU)|empowered weapon]]), powerful leap, [[Technomancer#Spell Cache (SU) - 1ST Level|spell cache]] (siccatite pincer)"
Perception: 16
Ranged:
  - name: Ranged
...
```statblock
creature: Jinsul, Base Commander
```
