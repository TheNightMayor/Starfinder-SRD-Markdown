...
defabilities:
  - name: "Defensive Abilities"
    desc: "retractable laser"
  - name: "[[Immunity (Ex or Su)|Immunities]]"
    desc: "[[Construct Immunities (Ex)]]"
  - name: "Weaknesses"
    desc: "light dependency"
EAC: 18
...
specialabil:
  - name: "Language Assimilation (Ex)"
    desc: "An anacite ambassador can spend 1 minute accessing a planet’s infosphere to learn any language commonly spoken on that planet. Alternatively, the anacite can learn a language by spending 1 day listening to it and reading it. An anacite ambassador can store knowledge of up to four languages at a time in this way, and it can choose which language to replace when it wants to learn a new one."
  - name: "Light Dependency (Ex)"
    desc: "An anacite ambassador can acquire power from dim or brighter light, and it can store power generated in this way. The anacite can operate in darkness for 2 hours. After this time, the anacite gains the sickened condition until it returns to an area of dim or brighter light."
  - name: "Retractable Laser (Ex)"
    desc: "An anacite ambassador’s retractable laser has a range increment of 90 feet. When not in use, this weapon is folded inside the anacite’s arm and hidden from sight. A creature unaware of the anacite’s hidden weapon must succeed at a DC 24 Perception check to find its compartment. The anacite can deploy or retract this weapon as a swift action or as part of making an attack or full attack. The weapon is mounted and leaves the anacite’s hands free, and the anacite can’t be disarmed of it. While deployed, the laser can be sundered as an item with a level equal to the anacite’s CR."
  - name: "Shortwave (Ex)"
