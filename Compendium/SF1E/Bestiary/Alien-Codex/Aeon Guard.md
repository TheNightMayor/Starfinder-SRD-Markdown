...
Gear:
  - name: gear
    desc: "[[Aeon Guard Battle Dress#Aeon Guard, Battle Dress (Trooper) |AG Trooper Battle Dress]] [[aeon stone#Aeon Stone, Clear Spindle | clear spindle aeon stone]], [[Jump Jets]]), [[Aeon Guard Rifle#Aeon Guard, Assault Rifle | AG assault rifle]] with 4 magazines (100 [[rounds#Rounds, Longarm and Sniper |longarm rounds]]), [[pulse gauntlet#Pulse Gauntlet, Thunderstrike|Thunderstrike pulse gauntlet]] with 2 [[Battery#Battery, Standard|Batteries]], [[Frag Grenade#Frag Grenade, Mk 2 | Frag grenade mk 2]], [[Incendiary Grenade#Incendiary Grenade, Mk 1 | Incindiary grenade mk 1]]"
hp: 48
Init: 5
KAC: 22
Languages: azlanti
Melee:
  - name: melee
    desc: thunderstrike pulse gauntlet +8 (1d6 + 5 B&So; critical knockdown)
modifier: 5
name: Aeon Guard
image: "[[Aeon Guard.png]]"
offabilities:
  - name: Offensive Abilities
    desc: "[[Sharpshoot]], [[Sharpshoot#SNIPER’S Aim (EX)| Sniper's Aim]]"
Perception: 8
Ranged:
  - name: ranged
    desc: AG assault rifle +11 (1d8 + 3 P) or frag grenade II +11 (explode [5ft., 1d8 + 3 P, DC 14]) or incindiary grenade I +11 (explode [5ft., 1d6 F plus 1d4 burn, DC 14])
saves:
  Fort: 5
  Ref: 3
  Will: 4
Senses: "[[Darkvision (Ex or Su)|Darkvision]] 60ft"
size: Medium
Skills:
  athletics: 8
  intimidate: 8
