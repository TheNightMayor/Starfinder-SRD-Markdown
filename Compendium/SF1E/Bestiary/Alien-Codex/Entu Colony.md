...
defabilities:
  - name: "Defensive Abilities"
    desc: "[[Amorphous (Ex)]], limited ooze benefits"
EAC: 10
Ecology:
  - name: "Environment"
    desc: "any"
  - name: "Organization"
    desc: "solitary, pair, or growth (3—20)"
Environment: any
Gear:
  - name: "Gear"
    desc: "[[Baton#Baton, Tactical|tactical baton]]"
hp: 12
Init: 0
KAC: 11
...
modifier: 0
name: "Entu Colony"
image: "[[Images/Aliens/Enemies/ooze/entu colony/entu colony.png]]"
...
specialabil:
  - name: "Limited Ooze Benefits (Ex)"
    desc: "Entu colonies gain a +2 racial bonus on saving throws against illusion, paralysis, poison, polymorph, sleep, and stunning effects, unless the effect specifies that it’s effective against oozes."
  - name: "Tactical Symbiosis (Ex)"
    desc: "Once per day as a standard action, an entu colony can temporarily merge a portion of themself with a willing non-entu colony creature they’ve telepathically communicated with and can touch. This symbiosis lasts until the beginning of the entu colony’s next turn"
Speed: 30 ft. 
statblock: true
...
```statblock
creature: Entu Colony
```

## Entu Colony Cr 1/2

during this time the entu colony can’t take any actions but can use each of the following abilities once. A creature can benefit from only one tactical symbiosis at a time. 
