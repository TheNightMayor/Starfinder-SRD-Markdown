...
Ecology:
  ...
  - name: Organization
    desc: solitary, pair, or excursion (3–7)
Environment: any (Arkanen, Osoro)
Gear:
  - name: Gear
    desc: "[[Lashunta Tempweave#Lashunta Tempweave, Basic|basic lashunta tempweave]], [[Polarity Gauntlet#Polarity Gauntlets, Static|static polarity gauntlets]] with 2 [[Battery#Battery, High-capacity|High-capacity Batteries]] (40 charges each), [[Polarity Rifle#static|static polarity rifle]] with 2 [[Battery#Battery, High-capacity|High-capacity Batteries]] (40 charges each), [[Serum of Healing#Serum of Healing, Mk 1|mk 1 serums of healing]] (2)"
hp: 50
Init: 5
KAC: 19
...
Melee:
  - name: Melee
    desc: static polarity gauntlets +9 to hit (1d6+5 E)
modifier: 5
name: Dirindi, Monster Hunter
image: "[[Dirindi Monster Hunter.png]]"
offabilities:
...
```statblock
creature: Dirindi, Monster Hunter
```
